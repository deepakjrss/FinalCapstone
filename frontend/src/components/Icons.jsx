...
import { cn } from '../theme/designSystem';

/**
 * Icon Components Collection
 * SVG-based icons for various use cases
 */
...
export const GlobeIcon = ({ className = 'w-6 h-6' }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20H7m6 0a9 9 0 110-18 9 9 0 0110 18z"
    />
  </svg>
);
